...
(add-lib 'io.github.clojure/java.doc {:git/tag "v0.1.4" :git/sha "34e381e"})
...
```bash
clojure -Sdeps '{:deps {org.clojure/java.doc {:git/url "https://github.com/clojure/java.doc" :git/tag "v0.1.4" :git/sha "34e381e"}}}' \
