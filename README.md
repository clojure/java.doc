...
(add-lib 'io.github.clojure/java.doc {:git/tag "v0.1.0" :git/sha "ffc70e5"})
...
```bash
clojure -Sdeps '{:deps {org.clojure/java.doc {:git/url "https://github.com/clojure/java.doc" :git/tag "v0.1.0" :git/sha "ffc70e5"}}}' \
